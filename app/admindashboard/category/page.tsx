...
import CategoryModal from "@/components/AdminDashboardModal/CategoryModal";
...
const AdminDashboardProductCategory: React.FC = () => {
        ...
        <Layout>
            <div className="shadow-md rounded-md p-6 bg-appBanner h-[78vh] overflow-y-scroll">
                <div className="flex items-center justify-between w-full border-b-2 border-b-appTitleBgColor pb-1">
                    <h2 className="text-2xl font-semibold text-white font-serif">Admin Category Page</h2>
                    <button
                        onClick={() => {
                            setModalData({ name: "", description: "" });
                            setCategoryModalOpen(true);
...
export default AdminDashboardProductCategory;
