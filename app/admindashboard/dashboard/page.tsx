...
import BarChart from "@/components/admindashboardcomponents/BarChart";
        ...
        <Layout>
            <div className="shadow-md rounded-md p-6 bg-appBanner h-[78vh] overflow-y-scroll ">
                <div className="flex items-center justify-between w-full border-b-2 border-b-appTitleBgColor pb-1">
                    <h2 className="text-2xl font-semibold text-white font-serif"> ADMIN DASHBOARD MANAGEMENT </h2>
                </div>
                ...
                <div className="w-full bg-appNav/60 p-4 flex flex-col items-center justify-between mt-6 rounded-lg gap-1">
                    ...
                    <div className="flex items-center justify-between w-full border-b-2 border-b-appTitleBgColor pb-1">
                        <h2 className="text-lg font-semibold text-white font-serif"> STATISTICS </h2>
                ...
                <div className="w-full bg-appNav/60 p-4 flex flex-col items-center justify-between mt-6 rounded-lg gap-1">
                    ...
                    <div className="flex items-center justify-between w-full border-b-2 border-b-appTitleBgColor pb-1">
                        <h2 className="text-lg font-semibold text-white font-serif"> ORDERS </h2>
                    </div>
