...
import AdminProductFormModal from "@/components/AdminDashboardModal/AdminProductFormModal";
        ...
        <Layout>
            <div className="shadow-md rounded-md p-6 bg-appBanner h-[78vh] overflow-y-scroll">
                <div className="flex items-center justify-between w-full border-b-2 border-b-appTitleBgColor pb-1">
                    <h2 className="text-2xl font-semibold text-white font-serif"> Admin Product Page </h2>
            ...
            <AdminProductFormModal isOpen={isModalOpen} onClose={closeModal} onSubmit={addProduct} editProduct={editProduct} />
        </Layout>
    );
};
