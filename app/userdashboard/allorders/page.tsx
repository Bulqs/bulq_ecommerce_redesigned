...
import UserOrderTable from '@/components/userdashboardcomponents/UserOrderTable';
        ...
        <UserLayout>
            <div className="shadow-md rounded-md p-6 bg-appTitleBgColor h-[78vh] overflow-y-scroll ">
                <div className="flex items-center justify-between w-full border-b-2 border-b-appBanner pb-1">
                    <h2 className="text-2xl font-semibold text-white font-serif"> Customer Orders </h2>
                </div>
                ...
                <UserOrderTable orders={filteredOrders} />
            </div>
        </UserLayout>
    );
}
