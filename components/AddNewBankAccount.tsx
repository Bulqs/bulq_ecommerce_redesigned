...
const AddNewBankAccount = ({modal}: modal) => {
  ...
  return (
    <div className='absolute top-[10px] w-[290px] h-[265px] bg-white ring-[#008080] ring-1 rounded-lg shadow-lg flex flex-col justify-center items-center gap-3'>
      <div className="relative flex flex-col">
        ...
        <label htmlFor="bankName" className="text-[12px] font-light italic">Name of Bank</label>
          <div className="w-[260px] h-[40px] ring-1 ring-[#008080] rounded-lg flex flex-row justify-around items-center gap-2">
            <div className="">
            <input type="text" name='bankName' placeholder='Bank Name' className="border-transparent focus:outline-none text-[12px] italic" />
            </div>
            <div className="">
            <FaCreditCard
          width={6}
        ...
        <button className="bg-[#008080] w-[200px] h-[25px] cursor-pointer rounded-lg text-white text-[12px] font-inter font-semibold italic hover:opacity-60" onClick={modal}>Save</button>
        </div>
      </div>
    </div>
  )
