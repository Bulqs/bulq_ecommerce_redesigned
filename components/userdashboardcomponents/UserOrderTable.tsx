...
import UserOrderModel from '../UserDashboardModal/UserOrderModel';


const UserOrderTable: React.FC<{ orders: CustomerOrder[] }> = ({ orders }) => {
            ...
            <table className="min-w-full border-collapse border border-gray-300">
                <thead className="bg-appTitleBgColor text-white font-normal font-sans">
                    <tr className="">
                        ...
                        <th className="border px-2 py-2">Delivery Type</th>
                ...
                <tbody>
                    {orders.map((order, index) => (
                        <tr key={order.id} className="text-center bg-white font-normal font-sans">
                            ...
                            <td className="border px-2 py-2">{order.deliveryType}</td>
