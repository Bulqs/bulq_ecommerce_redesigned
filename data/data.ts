...
import { IAllRatings, IAllVendorsBanner, IAllVendorsImageBottomTag, IAllVendorsProps, ICartCardProps, IProductCardProps, IProductCardProps2, Iimage, ISingleVendorBanner, IOrderReceipt, IMultipleForms } from "@/types";
...
const HomeProductsLists2: IProductCardProps2[] = [
...
export { initialFormData, Banner, HomeProductsLists, HomeProductsLists2, ProductsHomePagesItems, HomePageNike, HomePageAdidas, HomeAnimationimages, images, navigation, CartImageHolder, VendorDescHolder, VendorsBanner, VenorsTags, Reviews, VendorOnSalesDescHolder, SingleVendorBanner, social };